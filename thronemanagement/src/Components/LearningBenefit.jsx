...
const LearningBenefit = () => {
    return (
        <div className='xl:px-24 sh:pl-16 sh:pr-10 sp:px-7 px-4'>
            ...
            <div className='mt-4 gri flex flex-wrap justify-center mc:grid-cols-3 sd:grid-cols-2 gap-3'>
                <div className='border-[#797979B2] min-h-[461px] 3xl:max-w-[600px] max-w-[400px] relative flex flex-col gap-2 border bg-white shadow-lg shadow-[#00000040] rounded-[10px] pt-6'>
                ...
                <div className='border-[#797979B2] min-h-[461px] 3xl:max-w-[600px] max-w-[400px] relative flex flex-col gap-2 border bg-[#002B5B] text-white shadow-lg shadow-[#00000040] rounded-[10px] pl-3 pt-6'>
                ...
                <div className='border-[#797979B2] min-h-[461px] 3xl:max-w-[600px] max-w-[400px] relative flex flex-col gap-2 border bg-gradient-to-b from-[#002B5BBF] via-[#002B5BBF] text-white to-[#FFFFFF] shadow-lg shadow-[#00000040] rounded-[10px] pl-3 pt-6'>
