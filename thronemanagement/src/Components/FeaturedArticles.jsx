        ...
        <div className='xl:px-24 xl:py-20 sh:pl-16 sh:pr-10 sp:px-7 px-4 bg-[#1B1B1B] py-8 text-white'>
            <div className='grid grid-cols-2'>
                <div className='mk:col-span-1 col-span-2'>
                    ...
                    <p className='font-normal mt-8 sp:text-xl sr:text-lg text-base'>Stay connected with the latest business insights, research <br className='sd:block hidden' />findings, and success stories from our students, and alumni network.</p>
            ...
            <div className='grid mk:grid-cols-2 gap-10 mt-8'>
                <div className='flex flex-col gap-7'>
                    ...
                    <div>
                        <img className='w-[860px]' src={article} alt="" />
                        <p className='sd:text-[34px] sp:text-[27px] sr:text-[20px] leading-tight text-base mt-7 font-medium'>The Future of Swiss Business Leadership in a Digital Age</p>
                ...
                <div>
                    ...
                    <div className='sp:grid flex flex-col grid-cols-3 items-center gap-5 border-t pt-8 pb-5'>
                        <img className='w-full object-cover sp:min-h-[110px] rounded-[10px]' src={PUDD2} alt="" />
                    ...
                    <div className='sp:grid flex flex-col grid-cols-3 items-center gap-5 pt-8 pb-5'>
                        <img className='w-full object-cover sp:min-h-[110px] rounded-[10px]' src={PUDD3} alt="" />
                        <div className='flex flex-col gap-1 col-span-2'>
                    ...
                    <div className='sp:grid flex flex-col grid-cols-3 items-center gap-5 pt-8 pb-5'>
                        <img className='w-full object-cover sp:min-h-[110px] rounded-[10px]' src={PUDD4} alt="" />
                        <div className='flex flex-col gap-1 col-span-2'>
